...
I believe that is all I needed for the current deliverable. For reference to my code, I'll add in the files to my repository, they will all be labeled "React Pt 2" at the beginning.
